export default {
  ...
  item: ({ props }) => ({
    class: [
      ...
      // Size
      {
        // "w-full sm:w-[33.3333333%] md:w-[20%]  ": props.numVisible == 5,
        "lg:w-[33.33333%] md:w-[50%] w-full": props.numVisible == 3,
        "w-[50%]": props.numVisible == 2,

        "w-full h-full": props.orientation == "vertical",
        "w-full h-full": props.numVisible == 1,
      },
    ],
  }),
  itemcloned: ({ props }) => ({
