<template>
  <div class="relative">
    <svg
      class="absolute top-[7%] left-0 z-30 fill-secondary-color/80 brightness-50 w-[90px] h-[90px] md:w-[205px] md:h-[141px]"
    ...
    <svg
      class="absolute bottom-[7%] right-0 z-30 fill-secondary-color/80 brightness-50 w-[90px] h-[90px] md:w-[205px] md:h-[141px]"
      xmlns="http://www.w3.org/2000/svg"
      width="205"
      height="141"
      viewBox="0 0 205 141"
    ...
    <div
      class="text-center text-white bg-fixed bg-cover bg-secondary-color py-64"
      style="clip-path: polygon(100% 0%, 100% 35%, 151% 85%, 0px 100%, 0 14%)"
    >
      <div class="container">
        <blockquote
          class="text-[20px] md:text-[36px] leading-[2] z-50 relative"
        >
          <i>
